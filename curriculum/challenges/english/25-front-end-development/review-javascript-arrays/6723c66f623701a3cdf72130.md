...
Note: The `slice()` method creates a new array. If the array contains objects, their references are copied—not the actual objects. However, this distinction is not important here as objects are not yet introduced.
